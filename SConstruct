...
if env["platform"] != "windows":
    env.Append(CCFLAGS=["-Wno-error=non-virtual-dtor"])
    env.Append(CCFLAGS=["-Wno-error=ctor-dtor-privacy"])
...
env.Prepend(CPPPATH=["thirdparty/AEC3/base/abseil"])
env.Prepend(CPPPATH=["thirdparty/AEC3/audio_processing"])
env.Prepend(CPPPATH=["thirdparty/AEC3/audio_processing/aec3"])
env.Prepend(CPPPATH=["thirdparty/AEC3/audio_processing/include"])
